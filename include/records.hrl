...
% is_active: at start of each game, is_active is flipped to true, so 
%      we may distinguish them from players joining during game
-record(seat, {position, player, money=0.0, bet=0.0, last_action, cards=[], is_active=false}).
